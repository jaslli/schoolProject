              ...
              <li v-for="course in courseList" :key="course.id">
                <div class="cc-l-wrap">
                  <section class="course-img">
                    ...
                    <div class="cc-mask">
                      <a :href="'/course/'+course.id" title="开始学习" target="_blank" class="commbtn c-btn-1">开始学习</a>
                    </div>
                  </section>
...
export default {
  asyncData({params, erroe}) {
    return indexApi.getTeacherInfo(params.id)
     .then(response => {
       return {
